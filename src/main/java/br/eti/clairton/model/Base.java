...
@Cacheable
@MappedSuperclass
public abstract class Base extends Identificable implements Serializable, Cloneable {
	...
	/**
	 * Copy the instance usando {@link Base#clone()}
	 * 
	 * @see Base#clone()
	 * 
	 * @return T instance with values
	 */
	public <T extends Base> T copy() {
		try {
